...
document.writeln("			<div class=\"title\">济宁市任城区国有资产和地方金融监督管理局</div>");
...
document.writeln("	background: url(/picture/0/1911081544571812177.jpg) no-repeat center;");
...
document.writeln(".jiansuo{width: 185px;height: 40px;float: right;padding-top: 80px;}");
