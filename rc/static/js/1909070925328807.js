...
document.writeln("            <div class=\"title\">济宁市任城区人力资源和社会保障局</div>");
...
document.writeln("                <input type=\"text\" id=\"q\" name=\"q\" class=\"searchText ss-txt\" onfocus=\"if(this.value==\'请输入关键字\'){this.value=\'\'}\" onblur=\"if(this.value==\'\'){this.value=\'请输入关键字\'}\" value=\"请输入关键字\" autocomplete=\"off\">");
...
document.writeln(".w .title{font-size: 45px;color: #355e92;float: left;padding-left:109px;padding-top: 51px;}");
