	...
	*/
    ...
    InitDate.prototype = {
        ...
        setHtml:function(opts, self) {
            ...
            var topymSty = !isformat ? '<div class="jedateym" style="width:50%;"><i class="prev triangle1 yearprev"></i><span class="jedateyy" data-ym="24"><em class="jedateyear"></em><em class="pndrop"></em></span><i class="next triangle1 yearnext"></i></div>' + '<div class="jedateym" style="width:50%;"><i class="prev triangle1 monthprev"></i><span class="jedatemm" data-ym="12"><em class="jedatemonth"></em><em class="pndrop"></em></span><i class="next triangle1 monthnext"></i></div>' :'<div class="jedateym" style="width:100%;"><i class="prev triangle1 ymprev"></i><span class="jedateyy"><em class="jedateyearmonth"></em></span><i class="next triangle1 ymnext"></i></div>';
